"""Request schema for the temperature prediction endpoint."""
...
class TemperatureRequest(BaseModel):
    """
    Input features for the temperature model.
    ...
    def validate_calendar_date(self) -> "TemperatureRequest":
        """Ensure year/month/day form a real calendar date."""
        try:
