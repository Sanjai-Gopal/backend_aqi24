"""Request schema for the fire NRT (near-real-time) prediction endpoint."""
...
class FireNRTRequest(BaseModel):
    """
    Input features for the fire NRT model.

    IMPORTANT: this model was trained with exactly 8 features, in order:
    ...
    def validate_calendar_date(self) -> "FireNRTRequest":
        try:
